...
/* package minimalistic-haskell-microservice-0.1.0.0 */
#ifndef VERSION_minimalistic_haskell_microservice
#define VERSION_minimalistic_haskell_microservice "0.1.0.0"
#endif /* VERSION_minimalistic_haskell_microservice */
#ifndef MIN_VERSION_minimalistic_haskell_microservice
#define MIN_VERSION_minimalistic_haskell_microservice(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_minimalistic_haskell_microservice */
...
#define CURRENT_COMPONENT_ID "minimalistic-haskell-microservice-0.1.0.0-inplace-minimalistic-haskell-microservice"
